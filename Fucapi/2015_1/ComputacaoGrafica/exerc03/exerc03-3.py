...
def draw():
    global previous_time, dx, dy, dtheta, posx, posy, scalex, scaley, theta
...
def keyboard(char, x, y):
    global dx, dy, dtheta, posx, posy, scalex, scaley, theta
...
if __name__ == '__main__':
    ...
    glutCreateWindow("2a Avaliacao Parcial - 3")
