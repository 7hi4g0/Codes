...
class Scene(object):
    ...
    def __init__(self):
        ...
        self.enabled_lights = [True, False, False, False, False, False, False, False]
    ...
    def draw_scene_viewport(self):
        ...
        glLightfv(GL_LIGHT0, GL_POSITION, [15, 3, 10, 1])
